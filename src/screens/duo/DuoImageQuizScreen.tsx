...
import { useImageQuizGame } from "../../hooks/useImageQuizGame";
...
const DuoImageQuizScreen = ({ navigation, route }: any) => {
  const { p1, p2 } = route.params;
  const game = useImageQuizGame(p1, p2);
  ...
  const imageSource = QUIZ_IMAGE_MAP[game.current.imageKey];
...
export default DuoImageQuizScreen;
